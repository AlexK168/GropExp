"""
Django settings for GroupExp project.
...
SECRET_KEY = 'django-insecure-%dqyph8=gr5zqhzyvc87bm6ili82a-@im4+t+i3ph%&+74cxhx'
...
WSGI_APPLICATION = 'GroupExp.wsgi.application'
